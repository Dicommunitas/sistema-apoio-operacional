...
describe('FinalidadeAmostra e2e test', () => {
  ...
  it('should create and save FinalidadeAmostras', async () => {
    ...
    await promise.all([
      finalidadeAmostraUpdatePage.setLacreInput('lacre'),
      finalidadeAmostraUpdatePage.finalidadeAmostraSelectLastOption(),
      finalidadeAmostraUpdatePage.amostraSelectLastOption(),
    ]);
