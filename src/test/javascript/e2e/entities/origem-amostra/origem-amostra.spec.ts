...
describe('OrigemAmostra e2e test', () => {
  ...
  it('should create and save OrigemAmostras', async () => {
    ...
    await promise.all([
      origemAmostraUpdatePage.setDescricaoInput('descricao'),
      origemAmostraUpdatePage.origemAmostraSelectLastOption(),
      origemAmostraUpdatePage.amostraSelectLastOption(),
    ]);
