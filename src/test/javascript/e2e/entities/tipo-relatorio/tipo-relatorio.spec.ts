...
describe('TipoRelatorio e2e test', () => {
  ...
  it('should create and save TipoRelatorios', async () => {
    ...
    await promise.all([
      tipoRelatorioUpdatePage.setDescricaoInput('descricao'),
      tipoRelatorioUpdatePage.tipoRelatorioSelectLastOption(),
      tipoRelatorioUpdatePage.relatorioSelectLastOption(),
    ]);
