...
describe('Amostra e2e test', () => {
  ...
  it('should create and save Amostras', async () => {
    ...
    await promise.all([
      ...
      amostraUpdatePage.operacaoSelectLastOption(),
      amostraUpdatePage.origemAmostraSelectLastOption(),
      amostraUpdatePage.tipoAmostraSelectLastOption(),
      amostraUpdatePage.finalidadeAmostraSelectLastOption(),
    ]);
