...
public class ProblemaResourceIT {
    ...
    private static final SimNao DEFAULT_ACEITAR_FINALIZACAO = SimNao.SIM;
    private static final SimNao UPDATED_ACEITAR_FINALIZACAO = SimNao.NAO;
    ...
    public void searchProblema() throws Exception {
        ...
        // Initialize the database
        problemaRepository.saveAndFlush(problema);
        when(mockProblemaSearchRepository.search(queryStringQuery("id:" + problema.getId())))
            .thenReturn(Collections.singletonList(problema));
