...
import static br.com.transpetro.sistema_apoio_operacional.web.rest.TestUtil.sameInstant;
...
public class StatusResourceIT {
    ...
    private static final SimNao DEFAULT_SOLICITAR_FINALIZACAO = SimNao.SIM;
    private static final SimNao UPDATED_SOLICITAR_FINALIZACAO = SimNao.NAO;
