...
public class OrigemAmostraResource {
    ...
    public OrigemAmostraResource(OrigemAmostraRepository origemAmostraRepository, OrigemAmostraSearchRepository origemAmostraSearchRepository) {
    ...
    public ResponseEntity<OrigemAmostra> getOrigemAmostra(@PathVariable Long id) {
        ...
        Optional<OrigemAmostra> origemAmostra = origemAmostraRepository.findById(id);
