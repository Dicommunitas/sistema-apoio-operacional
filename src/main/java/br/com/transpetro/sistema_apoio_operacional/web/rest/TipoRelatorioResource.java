...
public class TipoRelatorioResource {
    ...
    public TipoRelatorioResource(TipoRelatorioRepository tipoRelatorioRepository, TipoRelatorioSearchRepository tipoRelatorioSearchRepository) {
    ...
    public ResponseEntity<TipoRelatorio> getTipoRelatorio(@PathVariable Long id) {
        ...
        Optional<TipoRelatorio> tipoRelatorio = tipoRelatorioRepository.findById(id);
