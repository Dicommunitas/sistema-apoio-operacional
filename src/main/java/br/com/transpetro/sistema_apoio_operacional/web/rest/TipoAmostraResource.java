...
public class TipoAmostraResource {
    ...
    public TipoAmostraResource(TipoAmostraRepository tipoAmostraRepository, TipoAmostraSearchRepository tipoAmostraSearchRepository) {
    ...
    public ResponseEntity<TipoAmostra> getTipoAmostra(@PathVariable Long id) {
        ...
        Optional<TipoAmostra> tipoAmostra = tipoAmostraRepository.findById(id);
