...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.domain.Status.class.getName() + ".statuses");
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.domain.Relatorio.class.getName());
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.domain.Relatorio.class.getName() + ".relatorios");
            ...
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.domain.FinalidadeAmostra.class.getName() + ".finalidadesAmostras");
