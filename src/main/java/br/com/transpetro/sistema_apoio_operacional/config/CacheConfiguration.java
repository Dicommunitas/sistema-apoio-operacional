package br.com.transpetro.sistema_apoio_operacional.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.domain.Problema.class.getName() + ".problemas");
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.domain.Status.class.getName());
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.domain.Status.class.getName() + ".responsavel1s");
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.domain.Status.class.getName() + ".responsavel2s");
            ...
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.domain.Amostra.class.getName() + ".amostras");
            createCache(cm, br.com.transpetro.sistema_apoio_operacional.domain.Amostra.class.getName() + ".responsavels");
