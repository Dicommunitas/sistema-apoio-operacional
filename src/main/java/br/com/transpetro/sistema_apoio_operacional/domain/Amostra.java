...
public class Amostra implements Serializable {
    ...
    @OneToMany(mappedBy = "amostra")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    private Set<User> responsavels = new HashSet<>();
    ...
    public Amostra addAmostra(FinalidadeAmostra finalidadeAmostra) {
        this.amostras.add(finalidadeAmostra);
        finalidadeAmostra.setAmostra(this);
        return this;
    }

    public Amostra removeAmostra(FinalidadeAmostra finalidadeAmostra) {
    ...
    public Set<User> getResponsavels() {
        return responsavels;
    }

    public Amostra responsavels(Set<User> users) {
        this.responsavels = users;
        return this;
    }

    public Amostra addResponsavel(User user) {
        this.responsavels.add(user);
        user.setAmostra(this);
        return this;
    }

    public Amostra removeResponsavel(User user) {
        this.responsavels.remove(user);
        user.setAmostra(null);
        return this;
    }

    public void setResponsavels(Set<User> users) {
        this.responsavels = users;
    }
