...
public class TipoFinalidadeAmostra implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "finalidadesAmostras", allowSetters = true)
    ...
    public FinalidadeAmostra getFinalidadeAmostra() {
        return finalidadeAmostra;
    }

    public TipoFinalidadeAmostra finalidadeAmostra(FinalidadeAmostra finalidadeAmostra) {
        this.finalidadeAmostra = finalidadeAmostra;
        return this;
    }

    public void setFinalidadeAmostra(FinalidadeAmostra finalidadeAmostra) {
        this.finalidadeAmostra = finalidadeAmostra;
    }
