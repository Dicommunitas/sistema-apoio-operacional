...
public class OrigemAmostra implements Serializable {
    ...
    public Amostra getOrigemAmostra() {
        return origemAmostra;
    }

    public OrigemAmostra origemAmostra(Amostra amostra) {
        this.origemAmostra = amostra;
        return this;
    }

    public void setOrigemAmostra(Amostra amostra) {
        this.origemAmostra = amostra;
    }
