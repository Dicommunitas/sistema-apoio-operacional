...
public class Relatorio implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    private Set<TipoRelatorio> relatorios = new HashSet<>();
    ...
    public Set<TipoRelatorio> getRelatorios() {
        return relatorios;
    }

    public Relatorio relatorios(Set<TipoRelatorio> tipoRelatorios) {
        this.relatorios = tipoRelatorios;
        return this;
    }

    public Relatorio addRelatorios(TipoRelatorio tipoRelatorio) {
        this.relatorios.add(tipoRelatorio);
        tipoRelatorio.setRelatorio(this);
        return this;
    }

    public Relatorio removeRelatorios(TipoRelatorio tipoRelatorio) {
        this.relatorios.remove(tipoRelatorio);
        tipoRelatorio.setRelatorio(null);
        return this;
    }

    public void setRelatorios(Set<TipoRelatorio> tipoRelatorios) {
        this.relatorios = tipoRelatorios;
    }
