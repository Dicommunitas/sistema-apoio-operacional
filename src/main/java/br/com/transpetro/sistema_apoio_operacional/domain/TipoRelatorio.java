...
public class TipoRelatorio implements Serializable {
    ...
    @OneToMany(mappedBy = "tipoRelatorio")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    ...
    public TipoRelatorio relatorios(Set<Relatorio> relatorios) {
        this.relatorios = relatorios;
        return this;
    }

    public TipoRelatorio addRelatorios(Relatorio relatorio) {
        this.relatorios.add(relatorio);
        relatorio.setTipoRelatorio(this);
        return this;
    }

    public TipoRelatorio removeRelatorios(Relatorio relatorio) {
        this.relatorios.remove(relatorio);
        relatorio.setTipoRelatorio(null);
        return this;
    }
