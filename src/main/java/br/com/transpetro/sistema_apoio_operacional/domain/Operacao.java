...
public class Operacao implements Serializable {
    ...
    public Operacao amostras(Set<Amostra> amostras) {
        this.amostras = amostras;
        return this;
    }

    public Operacao addAmostra(Amostra amostra) {
        this.amostras.add(amostra);
        amostra.setOperacao(this);
        return this;
    }

    public Operacao removeAmostra(Amostra amostra) {
        this.amostras.remove(amostra);
        amostra.setOperacao(null);
        return this;
    }
