...
public class Operacao implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "operacaos", allowSetters = true)
    private Amostra operacao;
    ...
    public Amostra getOperacao() {
        return operacao;
    }

    public Operacao operacao(Amostra amostra) {
        this.operacao = amostra;
        return this;
    }

    public void setOperacao(Amostra amostra) {
        this.operacao = amostra;
    }
    ...
    public Operacao amostra(Amostra amostra) {
