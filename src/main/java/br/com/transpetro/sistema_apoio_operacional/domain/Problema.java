...
public class Problema implements Serializable {
    ...
    public Status getProblema() {
        return problema;
    }

    public Problema problema(Status status) {
        this.problema = status;
        return this;
    }

    public void setProblema(Status status) {
        this.problema = status;
    }
    ...
    public Problema status(Status status) {
        this.status = status;
        return this;
    }
