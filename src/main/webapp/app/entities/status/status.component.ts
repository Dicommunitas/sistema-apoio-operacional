...
export class StatusComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    if (this.currentSearch) {
      this.statusService
        ...
        .subscribe((res: HttpResponse<IStatus[]>) => this.paginateStatuses(res.body, res.headers));
      return;
    }
  ...
  registerChangeInStatuses(): void {
    this.eventSubscriber = this.eventManager.subscribe('statusListModification', () => this.reset());
  }
  ...
  protected paginateStatuses(data: IStatus[] | null, headers: HttpHeaders): void {
